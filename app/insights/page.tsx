...
export default function InsightsPage() {
  return (
    <main id="main">
      <section className="pageHero pageHeroInsights"><div className="container"><p className="eyebrow">Insights</p><h1>Practical thinking for leaders navigating change.</h1><p>Articles, newsletters, founder conversations and lessons from technology transformation.</p></div></section>
